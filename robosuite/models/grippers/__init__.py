...
from .robotiq_hand_e_gripper import RobotiqHandEGripper
from .robotiq_hand_e_gripper_soft import RobotiqHandEGripperSoft
...
GRIPPER_MAPPING = {
    ...
    "RobotiqHandEGripper": RobotiqHandEGripper,
    "RobotiqHandEGripperSoft": RobotiqHandEGripperSoft,
