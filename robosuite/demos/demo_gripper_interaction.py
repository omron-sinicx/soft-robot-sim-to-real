...
from robosuite.utils.binding_utils import MjRenderContextOffscreen, MjSim, MjSimInteractive
...
if __name__ == "__main__":
    ...
    while True:
        ...
        toc = time.time() - tic
        time.sleep(max(model.opt.timestep - toc, 0))
        tic = time.time()
